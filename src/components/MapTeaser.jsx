...
const MapTeaser = () => {
  ...
  return (
    <div className="relative w-full h-64 rounded-3xl overflow-hidden shadow-xl border border-gray-100 group cursor-pointer" onClick={() => navigate('/map')}>
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-gray-900/90 via-gray-900/40 to-transparent flex items-center p-8 md:p-12">
        <div className="max-w-lg space-y-4">
          ...
          <button onClick={(e) => { e.stopPropagation(); navigate('/map'); }} className="mt-4 bg-white text-gray-900 px-6 py-3 rounded-xl font-bold hover:bg-orange-50 transition-colors flex items-center gap-2">
